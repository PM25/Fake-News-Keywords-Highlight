...
model = ClassificationModel('xlnet', 'result_x', use_cuda=True, cuda_device=1,
#model = ClassificationModel('xlnet', 'xlnet-base-cased', use_cuda=True, cuda_device=1,
        args={'fp16': False, 'overwrite_output_dir': True, 'num_train_epochs': 1, 'silent': False, 'output_dir': 'result_x'})
