...
model = ClassificationModel('bert', 'result', use_cuda=True, cuda_device=0,
#model = ClassificationModel('bert', 'bert-base-cased', use_cuda=True, cuda_device=0,
        args={'fp16': False, 'overwrite_output_dir': True, 'num_train_epochs': 1, 'silent': False, 'output_dir': 'result'})
